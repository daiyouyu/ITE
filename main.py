...
if __name__ == "__main__":
    ...
    if USE_PARALLEL:
        ...
        # iddpg, _ = train_iddpg(episodes=EPOCHS, train=TRAIN_DAYS, test=0, Federated=False, fed_method='DSFA')
        Fed_iddpg, _ = train_iddpg(episodes=EPOCHS, train=TRAIN_DAYS, test=0, Federated=True, fed_method='DSFA')
        FedAvg_iddpg, _ = train_iddpg(episodes=EPOCHS, train=TRAIN_DAYS, test=0, Federated=True, fed_method='FedAvg')
        ...
        FedAvg_iddpg = np.array(FedAvg_iddpg).T
